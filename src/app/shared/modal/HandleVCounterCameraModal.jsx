...
import { ebellInterlockCamera, doorInterlockCamera, vitalsensorInterlockCamera, pidsInterlockCamera } from '../../dashboard/api/apiService';
import styles from './HandleInterlockCameraModal.module.css';

export default function HandleVCounterCameraModal({ show, setShow, message, title, callback, clickPoint, selectObject, cameraList, deviceList, breathSensorList, pidsList }) {
